...
class AboutDoctorTwo extends StatefulWidget {
  const AboutDoctorTwo({super.key});

  @override
  State<AboutDoctorTwo> createState() => _AboutDoctorTwoState();
}

class _AboutDoctorTwoState extends State<AboutDoctorTwo> {
  @override

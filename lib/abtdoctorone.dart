...
class AboutDoctorOne extends StatefulWidget {
  const AboutDoctorOne({super.key});

  @override
  State<AboutDoctorOne> createState() => _AboutDoctorOneState();
}

class _AboutDoctorOneState extends State<AboutDoctorOne> {
  @override
